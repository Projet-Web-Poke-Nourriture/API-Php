 ...
 */
final class Version20240126163157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette ADD COLUMN etapes CLOB NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__recette AS SELECT id, auteur_id, nom, recommande, date FROM recette');
        ...
        $this->addSql('INSERT INTO recette (id, auteur_id, nom, recommande, date) SELECT id, auteur_id, nom, recommande, date FROM __temp__recette');
